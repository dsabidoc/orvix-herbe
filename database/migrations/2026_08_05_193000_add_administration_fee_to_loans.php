...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('loans', function (Blueprint $table) {
            $table->decimal('administration_fee', 15, 2)->default(0)->after('monthly_rate');
        });
        ...
        Schema::table('installments', function (Blueprint $table) {
            $table->decimal('administration_fee_amount', 15, 2)->default(0)->after('principal_amount');
        });
        ...
        DB::table('loans')
            ...
            ->each(function ($loan) use ($calculator) {
                $schedule = $calculator->calculate([
                    ...
                    'administration_fee' => $loan->administration_fee ?? '0.00',
    ...
    {
        Schema::table('installments', function (Blueprint $table) {
            $table->dropColumn('administration_fee_amount');
        });
