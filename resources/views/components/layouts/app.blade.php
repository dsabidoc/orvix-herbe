            ...
            <div class="app-shell min-h-screen overflow-x-hidden">
                <aside class="desktop-sidebar hidden border-r border-slate-200 bg-white px-5 py-6">
                    <a class="brand-logo-shell flex items-center gap-3 rounded-md" href="{{ route('dashboard') }}">
                        <img class="brand-logo-light h-12 w-auto max-w-full object-contain" src="{{ asset('assets/logo-orvix.svg') }}" width="180" height="58" alt="Orvix Prestamos">
                        <img class="brand-logo-dark h-12 w-auto max-w-full object-contain" src="{{ asset('assets/logo-orvix-dark.svg') }}" width="180" height="58" alt="Orvix Prestamos">
                    </a>
                ...
                <div class="mobile-menu-overlay fixed inset-0 z-40 hidden bg-slate-950/40" data-mobile-menu-overlay></div>
                <aside class="mobile-menu-shell fixed inset-y-0 left-0 z-50 flex w-[min(86vw,320px)] -translate-x-full flex-col border-r border-slate-200 bg-white px-5 py-5 shadow-xl transition-transform duration-200" data-mobile-menu>
                    <div class="flex items-center justify-between gap-3">
                        <a class="brand-logo-shell flex items-center gap-3 rounded-md" href="{{ route('dashboard') }}">
                            <img class="brand-logo-light h-10 w-auto max-w-full object-contain" src="{{ asset('assets/logo-orvix.svg') }}" width="180" height="58" alt="Orvix Prestamos">
                            <img class="brand-logo-dark h-10 w-auto max-w-full object-contain" src="{{ asset('assets/logo-orvix-dark.svg') }}" width="180" height="58" alt="Orvix Prestamos">
                        </a>
                ...
                <main class="min-w-0">
                    <header class="border-b border-slate-200 bg-white px-4 py-4 sm:px-6 lg:px-8">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <button class="mobile-menu-trigger grid size-10 shrink-0 place-items-center rounded-md border border-slate-300 bg-white text-slate-700 shadow-sm" type="button" data-open-mobile-menu aria-label="Abrir menu">
            ...
            <dialog id="confirm-paid-dialog" class="w-[min(92vw,520px)] rounded-lg border border-slate-200 bg-white p-0 text-left shadow-xl backdrop:bg-slate-950/40">
                <form method="dialog">
                    ...
                    <div class="flex flex-col justify-end gap-2 border-t border-slate-200 bg-slate-50 px-5 py-4 sm:flex-row sm:flex-wrap">
                        ...
                        <button class="rounded-md border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-bold text-amber-700" value="confirm-no-investors" data-no-investors-action>Pagado sin efectos</button>
                        <button class="rounded-md bg-[#0d9488] px-4 py-2 text-sm font-bold text-white" value="confirm" data-normal-payment-action>Pagado normal</button>
